...
### Changed
- **TypeScript 7 toolchain.** The development toolchain now uses TypeScript 7.0.2 (the native compiler, `tsc`); the package swap is behavior-neutral for the extension itself.
