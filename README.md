...
├─ ⠙ Agent  Code review of agent-runner.ts  4🛠︎ ·2⟳ ·↑7.2k↓1.5k 4%·12s
...
```
├─ ⠙ Explore  description  3🛠︎ ·5≤30⟳ ·↑10.2k↓1.8k 45%·1h 2m 3s
...
```
├─ ⠙ Explore  description trunc…  3🛠︎ ·5≤30⟳ ·↑10.2k↓1.8k 45%·1h 2m 3s  thinking…
```
